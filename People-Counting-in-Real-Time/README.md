...
I've modified the code of people counting going up and down from this repo : https://github.com/saimj7/People-Counting-in-Real-Time.git
Counting People going left to right in Real-Time using live video stream/IP camera in OpenCV.
...
```
python run_test.py --prototxt mobilenet_ssd/MobileNetSSD_deploy.prototxt --model mobilenet_ssd/MobileNetSSD_deploy.caffemodel --input videos/example_01.mp4
```
