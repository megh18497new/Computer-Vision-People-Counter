...
def run():
	...
	ct = CentroidTracker(maxDisappeared=90, maxDistance=50)
	trackers = []
	trackableObjects = {}
	...
	while True:
		...
		opc_text = "Number of unique id: {}".format(opc_count)
		cv2.putText(frame, opc_text, (5, 30), cv2.FONT_HERSHEY_SIMPLEX, 0.6, ( 0, 0, 0), 2)
